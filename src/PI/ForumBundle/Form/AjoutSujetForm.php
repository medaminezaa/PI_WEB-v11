...
class AjoutSujetForm extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder ->add('titre', TextType::class, array("attr" => array("style" => "margin-top:8px", "class" =>
            " form-control",'placeholder' => 'Votre mesage',)))
            ->add("theme",ChoiceType::class,array("choices"=>array(
                "Discussion"=>"Discussion",
                "Partage Souvenir"=>"Partage Souvenir"),"attr"=>array('placeholder' => 'Entrez le Titre du Sujet',"class" =>
                " form-control"
            )))
    ...
    {
        return 'piforum_bundle_ajout_sujet_form';
    }
}
